...
public class camera {
    ...
    public double outtakespeedfordistance(double powerin) {
        ...
        double y2 = 1.0; // april tag area furthest point from april tag
        double y1 = 0.5; // april tag area closets point to april tag
        double p2 = 0.41762;  // power furthest point from april tag
        double p1 = 0.40863; // power  closets point to april tag
